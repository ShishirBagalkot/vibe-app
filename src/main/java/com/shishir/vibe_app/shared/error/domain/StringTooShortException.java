package com.shishir.vibe_app.shared.error.domain;
...
public final class StringTooShortException extends AssertionException {
    ...
    static StringTooShortExceptionBuilder builder() {
    ...
    static final class StringTooShortExceptionBuilder {
        ...
        private String message() {
            return String.format("The value \"%s\" in field \"%s\" must be at least %d long but was only %d", value, field, minLength, value.length());
        }
