package com.shishir.vibe_app.shared.error.infra;
...
class BeanValidationErrorHandler {
    private static final String ERRORS = "errors";
    private static final Logger log = LoggerFactory.getLogger(BeanValidationErrorHandler.class);
