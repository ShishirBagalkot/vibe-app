package com.shishir.vibe_app.shared.authentication.application;

import com.nimbusds.jose.shaded.gson.internal.LinkedTreeMap;
import com.shishir.vibe_app.shared.authentication.domain.Role;
import com.shishir.vibe_app.shared.authentication.domain.Roles;
import com.shishir.vibe_app.shared.authentication.domain.Username;
...
public final class AuthenticatedUser {
    ...
    public static List<String> extractRolesFromToken(Jwt jwtToken) {
        ...
        return realmAccess.get("roles").stream().filter(role -> role.contains("ROLE_")).collect(Collectors.toList());
    }
}